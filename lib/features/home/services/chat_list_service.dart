    ...
    Future<ApiResponse<List<ChatModel>>> fetchChats(String userId) async{
        ...
        if(userId == "userId"){
            return SuccessResponse(
                List.of([
                     ChatModel("chatId1", "chatUser2", "https://i.pinimg.com/236x/b4/07/9b/b4079bd8f8b8b1272f4c66f420a5fe07.jpg", "chatUserId1", "hello", DateTime.now(), 1),
                     ChatModel("chatId2", "chatUser3", "https://i.pinimg.com/236x/b4/07/9b/b4079bd8f8b8b1272f4c66f420a5fe07.jpg", "chatUserId2", "hello", DateTime.now(), 100),
                     ...
                     ChatModel("chatId8", "chatUser9", "https://i.pinimg.com/236x/b4/07/9b/b4079bd8f8b8b1272f4c66f420a5fe07.jpg", "chatUserId8", "hello", DateTime.now(), 5),
                ])
            );
        }else {
